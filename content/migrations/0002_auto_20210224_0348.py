    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_ending', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.AlterField(
            model_name='profile',
            name='street_type',
            field=models.CharField(blank=True, choices=[('Blvd', 'Boulevard'), ('Ave', 'Avenue'), ('Cir', 'Circle'), ('Ct', 'Court'), ('Ter', 'Terrace'), ('Ln', 'Lane'), ('St', 'Street'), ('Dr', 'Drive'), ('Rd', 'Road')], max_length=4, verbose_name='Street type'),
        ),
    ]
